  ...
  PreparePlantilla(arrayPiezas) {
    ...
    for (var i = 0; i < cuadrado; i++) {
      ...
      for (var c = 0; c < cuadrado; c++) {
        ...
        columna.style.backgroundImage = "url(\"assets/Mario/d.gif\")"
  ...
  */
  ...
  if (arrayPiezzasGlobal[numeroPieza] == -1) {
    ...
    for (let a = 0; a < listadoBombas.length; a++) {
      document.getElementById("piece" + listadoBombas[a]).style.backgroundImage = "url(\"assets/Mario/boton6.gif\")";
    ...
    this.style.backgroundImage = "url(\"assets/Mario/ten.gif\")"
